...
const ITQuiz: React.FC = () => {
    ...
    const fetchQuestion = async (levelName: 'EASY' | 'MEDIUM' | 'HARD') => {
            setIsLoading(true);
            try {
                const response = await fetch(`http://localhost:8080/quiz/it?levelName=${levelName}`, {
                    method: 'POST',
                    headers: {
                ...
                <div className="flex items-center justify-center">   
                    <Card className="max-w-6xl w-full bg-black border-gray-600 p-8">
                        <CardHeader className="text-white text-left font-bold text-2xl">
                            ...
                            <CardDescription className="text-white text-base">The quiz contains 10 questions based on EASY, MEDIUM, HARD LEVEL in IT sectors. Please select the level and make sure you answer correctly. Good luck!</CardDescription>
                        </CardHeader>
