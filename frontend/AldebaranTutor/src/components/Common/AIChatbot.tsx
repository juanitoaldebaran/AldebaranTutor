...
const AIChatbot: React.FC = () => {
    ...
    const sendMessage = async () => {
        ...
        const newUserMessage: ChatResponse = {
        ...
        try {
            const response = await fetch("http://localhost:8080/ai/chat/send", {
                ...
                body: JSON.stringify({ chatText: userMessage }), 
            });
            ...
            const errorMessage: ChatResponse = {
                textContent: "I'm sorry, I couldn't process your message. Please try again",
                senderType: "AI",
                createdAt: new Date().getTime(),
            };
                ...
                <div className="flex-1 bg-gray-900/50 backdrop-blur-lg overflow-y-auto p-6 space-y-4 rounded-b-xl">
                    {isLoading && chatMessages.length === 0 ? (
                        ...
                        <>
                            ...
                            {/* Typing Indicator - MOVED OUTSIDE MAP */}
                            {isTyping && (
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-b-3xl p-6 border-t border-white/10">
                    <div className="flex gap-3">
                        ...
                        <button
                            ...
                            className="bg-green-600 px-6 text-white flex items-center gap-2 rounded-2xl hover:bg-green-800 hover:scale-101 duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
                            <Send />
                            Send
                        </button>
                    </div>
